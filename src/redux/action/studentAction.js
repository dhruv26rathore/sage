    ...
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://node.techforcode.xyz/api/student/login",
...
export const studentUpdatePassword = (passwordData) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://node.techforcode.xyz/api/student/updatePassword",
                data: passwordData
            })
...
export const chatHelper = (name) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://node.techforcode.xyz/api/student/getStudentByName",
                data: name
            })
...
export const getStudentByRegName = (registrationNumber) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://node.techforcode.xyz/api/student/getStudentByRegName",
...
export const getOTPStudent = (studentEmail) => {
    return async (dispatch) => {
        try {
            await axios({
                method: 'Post',
                url: 'https://node.techforcode.xyz/api/student/forgotPassword',
                data: studentEmail
            })
...
export const submitOTPStudent = (newPasswordWithOtp, history) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://node.techforcode.xyz/api/student/postOTP" ,
...
export const sendMessage = (room,messageobj) => {
    return async () => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: `https://node.techforcode.xyz/api/student/chat/${room}`,
                data: messageobj
            })
        }
        catch (err) {
...
export const getPrivateConversation = (roomId) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Get',
                url: `https://node.techforcode.xyz/api/student/chat/${roomId}`,
            })
...
export const previousChats = (senderName) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Get',
                url: `https://node.techforcode.xyz/api/student/chat/previousChats/${senderName}`,
            })
...
export const newerChats = (receiverName) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Get',
                url: `https://node.techforcode.xyz/api/student/chat/newerChats/${receiverName}`,
            })
...
export const studentUpdate = (updatedData) => {
    return async () => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: `https://node.techforcode.xyz/api/student/updateProfile`,
                data: updatedData
            })
        }
        catch (err) {
...
export const getAllSubjects = () => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Get',
                url: "https://node.techforcode.xyz/api/student/getAllSubjects"
            })
...
export const fetchAttendence = () => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Get',
                url: "https://node.techforcode.xyz/api/student/checkAttendence"
            })
...
export const getMarks = () => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Get',
                url: "https://node.techforcode.xyz/api/student/getMarks"
            })
