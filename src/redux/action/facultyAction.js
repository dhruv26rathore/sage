    ...
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://node.techforcode.xyz/api/faculty/login",
...
export const facultyUpdatePassword = (passwordData) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://node.techforcode.xyz/api/faculty/updatePassword",
                data: passwordData
            })
...
export const getOTPFaculty = (studentEmail) => {
    return async (dispatch) => {
        try {
            await axios({
                method: 'Post',
                url: 'https://node.techforcode.xyz/api/faculty/forgotPassword',
                data: studentEmail
            })
...
export const submitOTPFaculty = (newPasswordWithOtp, history) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://node.techforcode.xyz/api/faculty/postOTP",
...
export const fetchStudents = (department, year, section) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://node.techforcode.xyz/api/faculty/fetchStudents",
...
export const facultyUpdate = (updatedData) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: `https://node.techforcode.xyz/api/faculty/updateProfile`,
                data: updatedData
            })
...
export const markAttendence = (selectedStudents, subjectCode, department, year,
    ...
    return async(dispatch) => {
        try {
                await axios({
                method: 'Post',
                    url: "https://node.techforcode.xyz/api/faculty/markAttendence",
...
export const uploadMarks = (subjectCode, exam, totalMarks, marks,
    ...
    return async (dispatch) => {
        try {
            await axios({
                method: 'Post',
                url: "https://node.techforcode.xyz/api/faculty/uploadMarks",
                data: {
