    ...
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://node.techforcode.xyz/api/admin/login",
...
export const adminGetAllSubjects = () => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Get',
                url: "https://node.techforcode.xyz/api/admin/getSubjects",
            })
...
export const adminAddFaculty = (facultyCredential) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://node.techforcode.xyz/api/admin/addFaculty",
...
export const adminAddStudent = (studentCredential) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://node.techforcode.xyz/api/admin/addStudent",
...
export const adminAddSubject = (subjectCredential) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://node.techforcode.xyz/api/admin/addSubject",
...
export const adminAddAdmin = (adminCredentails) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://node.techforcode.xyz/api/admin/addAdmin",
...
export const adminGetAllFaculty = (department) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://node.techforcode.xyz/api/admin/getAllFaculty",
                data: department
            })
...
export const adminGetAllStudent = (searchCredentials) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://node.techforcode.xyz/api/admin/getAllStudent",
...
export const adminGetAllSubject = (department) => {
    return async (dispatch) => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: "https://node.techforcode.xyz/api/admin/getAllSubject",
                data: department
            })
