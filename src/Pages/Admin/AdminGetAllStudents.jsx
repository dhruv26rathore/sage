                ...
                <div className="container">
                    <div className="row mt-5">
                        <div className="col-md-4">
                            <form className="p-3 border border-dark rounded shadow" noValidate onSubmit={formHandler}>
                        ...
                        <div className="col-md-8">
                            ...
                            {store.admin.allStudent.length !== 0 && <table className="table border shadow">
