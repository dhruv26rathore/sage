                ...
                <div className="container">
                    <div className="row mt-5">
                        <div className="col-md-4">
                            <form className="p-3 border border-dark rounded shadow" form-inline noValidate onSubmit={formHandler}>
                                ...
                                {!isLoading && <button type="submit" className="btn btn-warning btn-block" style={{borderRadius:"5px",fontWeight:"bold"}}>Search</button>}
                            </form>
                        ...
                        <div className="col-md-8">
                            ...
                            {store.admin.allFaculty.length !== 0 && <table className="table border shadow">
