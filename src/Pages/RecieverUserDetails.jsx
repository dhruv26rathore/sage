                                ...
                                <div className="col-5">
                                    <div className="card" style={{ width: "18rem" }}>
                                        ...
                                        <div className="card-body">
                                            ...
                                            <NavLink exact activeClassName="active-page" className="nav-link" to={`/chat/${store.student.regNumStudent.registrationNumber}.${store.student.student.student.registrationNumber}`}>Chat</NavLink>
                                        </div>
                                    </div>
                                </div>
