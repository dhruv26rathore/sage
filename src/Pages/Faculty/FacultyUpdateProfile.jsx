                ...
                <div className="container mt-3">
                    <div className="row ">
                        <div className="col-md-5 w-100 m-auto">
                            <h1>Edit Profile</h1>
                            <form className="p-3 border border-dark rounded shadow" onSubmit={formHandler}>
                                ...
                                {!isLoading && <button type="submit" className="btn btn-warning" style={{borderRadius:"5px",fontWeight:"bold"}}>Update</button>}
                            </form>
                        </div>
                    </div>
                </div></> : (history.push('/'))}
