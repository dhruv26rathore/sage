    ...
    const filterStudentHelper = async () => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: 'https://node.techforcode.xyz/api/student/getAllStudents',
                data: {
                    department,
                    year,
                    section
            ...
            {store.student.isAuthenticated ? <>
                ...
                <div className="container pb-3">
                    {result.length === 0 && <div className="row">
                        <div className="col-md-3 border mt-4 shadow">
                            <div className="row pt-3 border">
                                <div className="col mb-2">
                                    <form className="form-inline" onSubmit={formHandler}>
                                        ...
                                        <button type="submit" className="btn btn-block btn-warning mt-1 ">🔍 Search</button>
                                    </form>
                                </div>
                            </div>
                            <div className="row justify-content-center mt-4 mb-5 border">
                                <div className="col">
                                ...
                                <div className="col">
                                    <div className="row">
                                        <div className="col-md-6 border">
                                            <h4 className="text-center mt-3">New Chats</h4>
                                            <table className="table border-left-0 border-top-0 border-bottom-0">
                                                <tbody>
                                                    {
                                        ...
                                        <div className="col-md-6 border">
                                            <h4 className="text-center mt-3">Older Chats</h4>
                    ...
                    {result.length !== 0 && <div className="row">
                        ...
                        <div className="Noticediv"><h1>Match Results</h1></div>
