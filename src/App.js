...
import FacultyAddNotice from './Pages/FacultyAddNotice'
...
import Notice from './Pages/StudentNotices';
    ...
    <div>
      <Router>
        <Switch>
          ...
          <Route exact path='/student/notice' component={Notice} />
          ...
          <Route exact path="/faculty/Notice" component={FacultyAddNotice}/>
          <Route exact path="/faculty/AddNotice" component={AddNotice}/>
          <Route exact path="/faculty/EditNotice/:id" component={EditNotice}/>
